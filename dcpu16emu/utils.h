...
struct _gcdx
{
	static const intmax_t value = _gcdx<_b, _a % _b>::value;
};

template<intmax_t _a>
struct _gcdx<_a, 0>
{
	static const intmax_t value = _a;
};

template<intmax_t _a, intmax_t _b>
struct _gcd
{
	static const intmax_t value = _gcdx<_abs<_a>::value, _abs<_b>::value>::value;
};
...
struct _lcm
{
	static const intmax_t value = (_a / _gcd<_a, _b>::value) * _b;
};
